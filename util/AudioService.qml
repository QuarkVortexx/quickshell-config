// https://github.com/tripathiji1312/quickshell/blob/main/services/Audio.qml
pragma Singleton
...
Singleton {
    ...
    readonly property bool sourceReady: source !== null && source?.ready && source?.audio !== null && !source.isSink
